                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-3 py-1">
                                                <div>
                                                    <img src="{{ asset('img/default-avatar.png') }}" class="avatar me-3" alt="image">
                                                </div>
                                        ...
                                        <td class="align-middle text-center">
                                            <a href="#" class="text-sm font-weight-bold text-info">Edit</a>
                                            <a href="#" class="text-sm font-weight-bold text-danger ps-3">Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
